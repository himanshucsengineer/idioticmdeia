...
<div class="all_post">
    <div class="container">
        <h3>Section First</h3>
        <hr>
        <form action="<?php echo base_url() ?>admin/whyus/first_update" method="post">
            <?php foreach ($whyus as $value) {
                if ($value['sec'] == "first") { ?>
...
<div class="all_post">
    <div class="container">
        ...
        <hr>
        <form action="<?php echo base_url() ?>admin/whyus/sec_update" method="post">
            <?php foreach ($whyus as $value) {
                if ($value['sec'] == "second") { ?>
                    <label for="">Heading</label>
                    <input type="text" name="head" placeholder="Enter Heading" value="<?php echo $value['head'] ?>" required>
...
<div class="all_post">
    <div class="container">
        <h3>Services</h3>
        <hr>
        <form action="<?php echo base_url() ?>admin/whyus/services" method="post" enctype="multipart/form-data">
            <label for="">Heading</label>
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <?php echo form_open(base_url('admin/whyus/delete_service'), array('method' => 'post')); ?>
...
<script>
    $(document).ready(function() {
        $('#lowinventory').DataTable({
            "ajax": "<?php echo base_url(); ?>admin/whyus/addinventory_api"
        });
