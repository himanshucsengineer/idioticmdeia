...
<div class="all_post">
    <div class="container">
        ...
        <hr>
        <form action="<?php echo base_url() ?>admin/casecate/create" method="post" enctype="multipart/form-data">
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <?php echo form_open(base_url('admin/casecate/delete_casecate'), array('method' => 'post')); ?>
...
<script>
    $(document).ready(function() {
        $('#lowinventory').DataTable({
            "ajax": "<?php echo base_url(); ?>admin/casecate/addinventory_api"
        });
