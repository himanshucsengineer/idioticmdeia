...
<div class="all_post">
    <div class="container">
        <h3>Add Brands</h3>
        <hr>
        <form action="<?php echo base_url() ?>admin/brands/add" method="post" enctype="multipart/form-data">
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <?php echo form_open(base_url('admin/brands/delete_brand'), array('method' => 'post')); ?>
